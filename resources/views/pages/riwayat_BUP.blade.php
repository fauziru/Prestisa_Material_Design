...
@foreach($history as $p)
    ...
    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo{{$p->order_number}}">{{$p->order_number}}</button>
  <div id="demo{{$p->order_number}}" class="collapse">
  ...
  <div class="card"  style="border:2px solid black;color:black;">
        ...
        <tr>
        	...
        	<td>Id</br></br>{{$p->id}}</td>
        	<th>Total Pembelian</br></br>Rp.{{$p->total}}</th>
        </tr>
        ...
        <tr>
         ...
         <tr>
        	...
        	<td>Jumlah Pembelian</br></br>{{$p->qty}}</td>
        </tr>
    </table>
  </div>
